...
<body>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="/booking/detail/${displayInfoImageDto.getDisplayInfoId()}" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <c:forEach items="${productPriceDtoList}" var="productPriceDtoList">
                        	${productPriceDtoList.getKoreanPriceTypeName()} 가격 : ${productPriceDtoList.getFormattedPrice()}원<br>
                        </c:forEach>
                			...
                			<div class="qty" id="ticket_box">
	                            ...
	                            <div class="qty_info_icon"> 
	                            	<strong class="product_amount"> 
	                            		<span>${productPriceDtoList.getKoreanPriceTypeName()}</span> 
	                            	</strong> 
	                            	<strong class="product_price"> 
	                            		<span class="price">${productPriceDtoList.getFormattedPrice()}</span> 
	                            		<span class="price_type">원</span>
	                            	</strong> 
	                            	<em class="product_dsc">${productPriceDtoList.getFormattedPrice()}원 (${productPriceDtoList.getDiscountRate()}% 할인가)</em> 
	                            </div>
	                        </div>
                		</c:forEach>
                    </div>
                </div>
                <div class="section_booking_form" id="reservation_info_wrap">
                    ...
                    <div class="section_booking_agreement" id="agreement_box_wrap">
                        <div class="agreement all"> 
                        	<input type="checkbox" id="chk3" class="chk_agree"> 
                       		<label for="chk3" class="label chk_txt_label agree_all"> 
                       			<span class="agree_all">이용자 약관 전체동의</span> 
                       		</label>
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a class="btn_agreement"> <span class="btn_text">보기</span> <i id="agree_arrow_button" class="fn fn-down2"></i> </a>
