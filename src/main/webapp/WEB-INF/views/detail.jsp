...
<body>
            ...
            <div>
                <div class="section_visual">
                    <header>
                        ...
                        <a href="/booking/myreservation" class="btn_my"> <span class="viewReservation" title="예약확인">예약확인</span> </a>
                    </header>
                                    ...
                                    <li class="item" style="width: 414px;"> 
                                        ...
                                        <div class="visual_txt">
                                            <div class="visual_txt_inn">
                                                ...
                                                <p class="visual_txt_dsc">${productDto.getDescription()}</p>
                                            </div>
                                        </div>
                                    </li>
                                    </c:forEach>
                ...
                <div class="section_review_list">
                    ...
                    <a class="btn_review_more" href="/booking/review/${productDto.getDisplayInfoId()}"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
                    ...
                    <div class="detail_location hide">
                        <div class="box_store_info no_topline">
                           	<a href="" class="store_location" title="지도웹으로 연결">
                                <img class="store_map img_thumb" alt="map" src="${pageContext.request.contextPath}/${displayInfoDto.getSaveFileName()}">
                            ...
                            <div class="store_info">
                                <div class="store_addr_wrap">
                                    ...
                                    <p class="store_addr store_addr_bold">${displayInfoDto.getPlaceStreet()}</p>
                                    <p class="store_addr">
                                        <span class="addr_old">지번</span>
                                        <span class="addr_old_detail">${displayInfoDto.getPlaceLot()}</span>
                                    </p>
                                    <p class="store_addr addr_detail">${displayInfoDto.getPlaceName()}</p>
                                </div>
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:${displayInfoDto.getTel()}" class="store_tel">${displayInfoDto.getTel()}</a></span> </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script type="rv-template" id="comments">
		<li class="list_item">
            <div>
                <div class="review_area">
                    <div class="thumb_area">
