            ...
            <div class="wrap_review_list">
                <div class="review_header">
                    <div class="top_title gr">
                        <a href="/booking/detail/${productDto.getDisplayInfoId()}" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                        ...
                        <div class="short_review_area">
                            <div class="grade_area"> 
                            	<span class="graph_mask"> 
                            		<em class="graph_value" style="width: ${averageScore*20}%;"></em> 
                            	</span> 
                            	...
                            	<em class="green">${commentDtoList.size()}건</em> 등록</span>                                
                            </div>
